...
```js
module.exports = {
  title: "Dev Hajun", // Your website title
  description: `Hajun Ryu's Blog`, // Your website description
  author: "Hajun Ryu", // Maybe your name
  ...
  links: {
    github: "https://github.com/HaJunRyu", // Your github repository
  },
